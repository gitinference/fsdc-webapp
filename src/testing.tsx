...
const CoffeeQuestionnaire: React.FC = () => {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif", maxWidth: "100%", margin: "auto" }}>
          ...
          <label>
            ...
            <table>
              <tr>
                ...
                <tr>
                  <th>
                    &emsp;&emsp;&emsp;Gastos Administrativos ($) (Libretas, Papel, Bolígrafos, Libros de Recibos)
                  </th>
                  <th>
                    <input
                    type="number"
            ...
            <table>
              <tr>
                <th>
                  <strong>move </strong>¿Cuántas personas viven en el hogar del administrador de la finca? 
                  (incluyendo a usted)&emsp;&emsp;&emsp;
                </th>
                <th>
                  <input type="number" placeholder="Total personas"/>
                </th>
              </tr>
            ...
            <tr>
              <th>
                <strong>move </strong> ¿Cuál es la titularidad de la tierra donde está ubicada la finca?
              </th>
            </tr>
            <tr>
                <th>
            ...
            <table>
              ...
              <tr>
                <th>
                  ...
                  &emsp;&emsp;&emsp;<input type="checkbox" name="cultivo" className="checkbox-spacing" style={{marginRight:"10px"}}/>
                  &emsp;&emsp;&emsp;<label htmlFor="otros_frutales">Otros frutales o farináceos (si le aplica, favor de especificar cuales son)</label><br/>
                  &emsp;&emsp;&emsp;<input type="text" placeholder="Especifique frutales"></input><br/>
                  &emsp;&emsp;&emsp;<input type="checkbox" name="cultivo" className="checkbox-spacing" style={{marginRight:"10px"}}/>
                  &emsp;&emsp;&emsp;<label htmlFor="hortalizas">Hortalizas (si le aplica, favor de especificar cuales son)</label><br/>
                  &emsp;&emsp;&emsp;<input type="text" placeholder="Especifique hortalizas"></input><br/>
                  &emsp;&emsp;&emsp;<input type="checkbox" name="cultivo" className="checkbox-spacing" style={{marginRight:"10px"}}/>
                  &emsp;&emsp;&emsp;<label htmlFor="animales">Animales</label><br/>
                  &emsp;&emsp;&emsp;<input type="text" placeholder="Especifique frutales"></input><br/>
                </th>
              </tr>
