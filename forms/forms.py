...
class PRPart3Form(forms.Form):
    ...
    n4 = forms.ChoiceField(
        ...
        choices=[("si", "Si (Pase a la pregunta N4a)"), ("no", "No"), ("no_recuerdo", "No recuerdo")],
        widget=forms.RadioSelect
    )
